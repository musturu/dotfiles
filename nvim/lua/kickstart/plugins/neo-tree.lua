...
return {
  ...
  keys = {
    ...
    { '<Tab>e', ':Neotree<CR>', desc = 'go to Navigation', silent = true },
  },
  enable_git_status = true,
  open_files_do_not_replace_types = { 'terminal', 'aerial', 'qf' },
  opts = {
    filesystem = {
      window = {
        mappings = {},
  ...
  config = function()
    require('neo-tree').setup {
      ...
      open_files_do_not_replace_types = { 'terminal', 'aerial', 'qf' }, -- when opening files, do not use windows containing these filetypes or buftypes
